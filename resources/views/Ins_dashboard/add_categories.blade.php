...
<body class="bg-custom-dark text-gray-100">
    ...
    <main class="lg:ml-64 pt-20 p-6">
        ...
        <div class="bg-custom-darker p-8 rounded-lg shadow-lg max-w-md mx-auto">
            <h2 class="text-xl font-semibold text-accent mb-4">Add Category</h2>
            <form action="" method="POST" class="space-y-4">
                <div>
                    <label for="category-name" class="block text-accent mb-2">Category Name</label>
                ...
                <div>
                    <label for="category-description" class="block text-accent mb-2">Description</label>
                    <textarea id="category-description" name="category_description" rows="3"
