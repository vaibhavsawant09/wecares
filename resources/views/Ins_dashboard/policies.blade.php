...
<body class="bg-custom-dark text-gray-100">
        ...
        <div class="flex items-center justify-between px-6 py-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="w-8 h-8 rounded-full bg-accent overflow-hidden">
                    <a href="{{url('ins_dashboard/profile')}}"><img src="466132576_1700000777457980_7640509984743529447_n.jpg" alt="Profile Image" class="w-auto h-full object-cover"></a>
                </div>
    ...
    <main class="lg:ml-64 pt-20 p-6">
        <div class="flex justify-between mb-6">
            <a href="{{url('ins_dashboard/add_policy')}}">
