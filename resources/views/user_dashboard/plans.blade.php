...
<main class="lg:ml-64 pt-20 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="relative bg-gradient-to-r from-[#D8E28C] to-[#114A43] p-8 rounded-xl shadow-lg transform transition-transform hover:scale-105 hover:shadow-2xl">
            ...
            <div class="border-t pt-4 text-white flex justify-between items-center">
                <p><strong>Date Created:</strong> 01/01/2024</p>
                <a href="pay.php?policy_id=1&name=Health%20Insurance&premium=10000"
                    class="bg-white text-[#114A43] px-4 py-2 rounded-full font-semibold text-sm hover:bg-hover-accent transition">
                    Apply
                </a>
            </div>
        </div>
        ...
        <div class="relative bg-gradient-to-r from-[#114A43] to-[#D8E28C] p-8 rounded-xl shadow-lg transform transition-transform hover:scale-105 hover:shadow-2xl">
            ...
            <div class="border-t pt-4 text-white flex justify-between items-center">
                ...
                <a href="pay.php?policy_id=2&name=Life%20Insurance&premium=15000"
                    class="bg-white text-[#114A43] px-4 py-2 rounded-full font-semibold text-sm hover:bg-hover-accent transition">
                    Apply
                </a>
            </div>
        ...
        <div class="relative bg-gradient-to-r from-[#D8E28C] via-white to-[#114A43] p-8 rounded-xl shadow-lg transform transition-transform hover:scale-105 hover:shadow-2xl">
            ...
            <div class="border-t pt-4 text-[#114A43] flex justify-between items-center">
                <p><strong>Date Created:</strong> 20/02/2024</p>
                <a href="pay.php?policy_id=3&name=Accident%20Insurance&premium=8000"
                    class="bg-[#114A43] text-white px-4 py-2 rounded-full font-semibold text-sm hover:bg-hover-accent transition">
                    Apply
                </a>
            </div>
        </div>
